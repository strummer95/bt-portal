...
// --- Self-healing: ensure created_by column exists ---
    ...
    // Other > Accounts: BT Accounts' order queue, for whoever it lets in.
    $btp_bta_orders = shortcode_exists('bta_staff_orders') && current_user_can('bta_handle_orders');
  ...
  <div class="bt-header-row bt-header-row-top">
    ...
    <div class="header-actions">
      <div class="header-tabs">
        ...
        <div class="tab" data-tab="vendors" onclick="btSwitchTab('vendors')"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="margin-right:5px;vertical-align:middle;"><path d="M3 9l1-5h16l1 5"/><path d="M4 9v11a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V9"/><path d="M9 21v-7h6v7"/></svg>Vendors</div>
        <div class="tab tab-more" id="btMoreTab" onclick="btToggleMore(event)">
          ...
          <div class="tab-menu" id="btMoreMenu">
            ...
            <?php if ( $btp_bta_orders ) : ?>
            <div class="tab-menu-item" data-tab="accounts" onclick="btSwitchTab('accounts')"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/><line x1="2" y1="13" x2="22" y2="13"/></svg>Accounts</div>
            <?php endif; ?>
...
<?php if ( $btp_bta_orders ) : ?>
<!-- ACCOUNTS TAB: BT Accounts renders its own order queue; the portal only hosts it -->
<div id="bt-tab-accounts" class="tab-content" style="width:100%;box-sizing:border-box;">
  <div style="background:#f4f5f9;min-height:calc(100vh - 120px);width:100%;box-sizing:border-box;">
    <?php echo do_shortcode('[bta_staff_orders]'); ?>
  </div>
</div>
<?php endif; ?>
...
function btSwitchTab(tab, push) {
  // A tab can be missing for this person (Accounts is only rendered for staff
  // who have it). Landing on its link falls back to Schedule instead of
  // throwing and taking the rest of the page down with it.
  if (!document.getElementById('bt-tab-'+tab)) tab = 'schedule';
